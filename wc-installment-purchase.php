...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	add_action( 'woocommerce_after_shop_loop_item', 'button_installment_purchase', 30 );
	add_action( 'woocommerce_single_product_summary', 'button_installment_purchase', 35 );

	function button_installment_purchase() {
